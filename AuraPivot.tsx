 ...
 */
export interface AuraPivotProps extends Omit<
 ...
 * `<ThemeProvider>`.
 */
const Pivot = forwardRef<AuraPivotRef, AuraPivotProps>(
  function Pivot(props, ref) {
    const {
      width = '100%',
      height = '100%',
      locale,
    ...
    const contextValue = useMemo(
      ...
      // optsTick is a manual version counter bumped whenever the engine's
      // internal options mutate in place; it is not read directly but forces
      // this memo to recompute so descendants observe the change.
